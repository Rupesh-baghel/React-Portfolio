...
function Footer ()  {
  return (
    ...
    <p className="text-xs text-gray-300">Rupesh Kumar © 2024</p>
    <div className="black-logo my-4">
   
      <a href="">
        <svg xmlns="http://www.w3.org/2000/svg" id="my-svg" width="50" height="50" viewBox="0 0 256 256">
    ...
    <ul className="mx-auto flex items-center justify-center gap-6 text-[#b0b2c3]">
        ...
        <li>
            <a href="https://github.com/Rupesh-baghel" rel="" target='_blank'>
        ...
        <li>
            <a href="//wa.me/9193112760" target='_blank'>
                <svg className='w-6 hover:text-white' aria-hidden="true" focusable="false" data-prefix="fab"
      ...
      <li>
        <a href="mailto:rupeshkumar98900@gmail.com" title="mail" target="_blank">
